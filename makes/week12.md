...
## Process Notes
Sources Used: For this personal AI audit, I utilized a weekly query log alongside several academic and industrial sources. To establish a CO2 baseline, I relied on research from Epoch AI, which estimates that a single ChatGPT query results in approximately 0.15 grams of CO2 based on an average energy consumption of 0.3 to 0.4 watt-hours per response. For a broader context on the "planetary costs" of these systems, I consulted Kate Crawford’s Atlas of AI, which details the extractive nature of the hardware supply chain, and the Strubell et al. (2019) study, which provides benchmarks for comparing AI emissions to daily human activities like air travel and car ownership.
Hardest Data to Find:  The most difficult data to pinpoint was the specific water footprint for my individual queries. While research suggests that every 20 to 50 queries consume roughly half a liter of water for cooling, this varies wildly based on the data center's location and the local climate. Furthermore, because tech companies treat exact energy consumption as "highly guarded corporate secrets," it is nearly impossible to know the precise energy mix (renewables vs. fossil fuels) powering the specific servers used for my interactions.
